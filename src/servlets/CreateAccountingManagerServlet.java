...
/**
 * Servlet implementation class CreateAccountingManagerServlet
 */
@WebServlet("/CreateAccountingManagerServlet")
public class CreateAccountingManagerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateAccountingManagerServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(cond.equals("regs")){
	        ...
	        if(accepted){
	        	int result = DBHelper.createUser(user, pass, Account.TYPE_ACCOUNTINGMANAGER, email, fname, mname, lname);
